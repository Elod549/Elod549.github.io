...
class Quform_Validator_Regex extends Quform_Validator_Abstract
{
    ...
    public function isValid($value)
    {
        ...
        $value = (string) $value;
        $match = preg_match($this->_pattern, $value);

        if ((!$match && !$this->_invert) || ($match && $this->_invert)) {
    ...
    /**
     * Set whether the match should be inverted
     *
     * @param boolean $flag
    ...
    /**
     * Get whether the match should be inverted
     *
     * @return boolean
     */
